...
class TimelinePlugin extends BasePlugin {
    ...
    initTimeline() {
        ...
        const timeInterval = (_d = this.options.timeInterval) !== null && _d !== void 0 ? _d : this.defaultTimeInterval(pxPerSec);
        const primaryLabelInterval = (_e = this.options.primaryLabelInterval) !== null && _e !== void 0 ? _e : this.defaultPrimaryLabelInterval(pxPerSec);
        const primaryLabelSpacing = this.options.primaryLabelSpacing;
        const secondaryLabelInterval = (_f = this.options.secondaryLabelInterval) !== null && _f !== void 0 ? _f : this.defaultSecondaryLabelInterval(pxPerSec);
        ...
        const notchEl = createElement('div', {
            style: {
                ...
                opacity: `${(_g = this.options.secondaryLabelOpacity) !== null && _g !== void 0 ? _g : 0.25}`,
                position: 'absolute',
                zIndex: '1',
            },
        });
